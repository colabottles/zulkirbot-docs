...
The Gauntlet is a multi-stage campaign — 5 escalating encounters ending in a minor boss. It was the first campaign mode added to ZulkirBot and serves as the baseline for all named campaigns.
...
After typing `!campaign`, you have **30 seconds** to choose your mode:
...
| Stage | Encounter | Notes |
| --- | --- | --- |
| 1 | Skirmish | Weak enemies, intro encounter |
| 2 | Ambush | Two enemies attacking simultaneously |
| 3 | Patrol | Tougher single enemy with a special ability |
| 4 | Elite Guard | Near-boss tier with a power move or debuff |
| 5 | Minor Boss | Named villain, high HP, unique special attack |

A **rest shrine** appears before each stage after the first, restoring **20 HP** to all living players.
